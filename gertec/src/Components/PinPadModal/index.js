...
import { printComprovanteGertec } from "../../Functions/printerGertec";
...
const PinPadModal = ({openModal, closeModal, data, setData, AprovarCompra }) => {
    ...
    const Recebimento = async (item) => {
        ...
        if (recibo.success.CODRESP == '0'){
            ...
            .then((res) => {
                printComprovanteGertec(recibo.success.VIA_CLIENTE, recibo.success.VIA_ESTABELECIMENTO)
                mutate('/vendas/venda/')
