            ...
            <View style={{ padding: 10}}>
                        ...
                        <View>
                            ...
                            <Picker
                                ...
                                { data.forma == 'CC' && parseInt(total_venda) >= 300 || user.tipouser !== "V" && <Picker.Item label="2" value= {2}/> }
                                { data.forma == 'CC' && parseInt(total_venda) >= 600 || user.tipouser !== "V" && <Picker.Item label="3" value= {3}/> }
                                { data.forma == 'CC' && parseInt(total_venda) >= 800 || user.tipouser !== "V" && <Picker.Item label="4" value= {4}/> }
                                { data.forma == 'CC' && parseInt(total_venda) >= 1000 || user.tipouser !== "V" && <Picker.Item label="5" value= {5}/> }
                                { data.forma == 'CC' && parseInt(total_venda) >= 1200 || user.tipouser !== "V" && <Picker.Item label="6" value= {6}/> }
                                { data.forma == 'CC' && parseInt(total_venda) >= 1400 || user.tipouser !== "V" && <Picker.Item label="7" value= {7}/> }
                                { data.forma == 'CC' && parseInt(total_venda) >= 1600 || user.tipouser !== "V" && <Picker.Item label="8" value= {8}/> }
                                { data.forma == 'CC' && parseInt(total_venda) >= 1800 || user.tipouser !== "V" && <Picker.Item label="9" value= {9}/> }
                                { data.forma == 'CC' && parseInt(total_venda) >= 2000 || user.tipouser !== "V" && <Picker.Item label="10" value= {10}/> }
                            </Picker>
                        </View>
                        <View>
